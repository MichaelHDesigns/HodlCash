Contributing to Hodl Cash
============================

The Hodl Cash project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hodlcash-project/hodlcash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Hodl Cash project, and is not to be
confused with overall HodlCash Network Protocol consensus changes.

Whether a pull request is merged into Hodl Cash rests with the project merge
...
Patches that change HodlCash consensus rules are considerably more involved than
...
Where a patchset proposes to change the HodlCash consensus, it must have been
...
The project leader is the release manager for each Hodl Cash release.
