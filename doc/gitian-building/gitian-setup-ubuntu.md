...
The build script we'll be using is contained in the HodlCash github repository ([contrib/gitian-build.py](https://github.com/hodlcash-project/hodlcash/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the HodlCash repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/HodlCash-Project/HodlCash/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, hodlcash-detached-sigs, and hodlcash GitHub repos.
