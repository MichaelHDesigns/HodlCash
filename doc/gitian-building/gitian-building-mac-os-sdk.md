...
The script [extract-osx-sdk.sh](https://github.com/hodlcash-project/hodlcash/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
hodlcash/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/hodlcash-project/hodlcash/blob/master/doc/README_osx.md) for troubleshooting tips.