...
from test_framework.hodlcash_node import HodlCashTestNode
...
class HodlCash_ColdStakingTest(HodlCashTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(HodlCashTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 HODL from the pot)
