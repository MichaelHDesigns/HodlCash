...
"""Verify that starting hodlcash with -h works as expected."""
import subprocess

from test_framework.test_framework import HodlCashTestFramework
from test_framework.util import assert_equal

class HelpTest(HodlCashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hodlcash with -h for help text")
        ...
        self.log.info("Start hodlcash with -version for version information")
