// Copyright (c) 2017-2020 The HodlCash developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zHODL Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zHODL.";
            else if (!mint.isSeedCorrect)
                strReason = "The zHODL seed used to mint this zHODL is not the same as currently hold in the wallet";
            else
