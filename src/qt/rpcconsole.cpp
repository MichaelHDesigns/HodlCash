                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHODLPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzHODLPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzHODLPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHODLPathCustom.empty()) && nCustomBackupThreshold > 0) {
