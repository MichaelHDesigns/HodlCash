...
#include "qt/hodlcash/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(HodlCashGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-hodlcash");
