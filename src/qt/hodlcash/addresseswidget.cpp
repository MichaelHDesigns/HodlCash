...
#include "qt/hodlcash/forms/ui_addresseswidget.h"
#include "qt/hodlcash/addresslabelrow.h"
#include "qt/hodlcash/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(HodlCashGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter HodlCash address"));
