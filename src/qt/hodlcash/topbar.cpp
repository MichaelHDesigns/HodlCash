...
#include "qt/hodlcash/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/hodlcash/lockunlock.h"
#include "qt/hodlcash/qtutils.h"
#include "qt/hodlcash/receivedialog.h"
...
TopBar::TopBar(HodlCashGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("HodlCash")
    updateDisplayUnit();
