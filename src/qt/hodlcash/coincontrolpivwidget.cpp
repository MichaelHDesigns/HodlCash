...
#include "qt/hodlcash/coincontrolpivwidget.h"
#include "qt/hodlcash/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select HODL Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("HODL");
    ...
    ui->labelValueAfter->setText("0.00 HODL");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 HODL");
    ui->labelValueFee->setText("0.00 HODL");
