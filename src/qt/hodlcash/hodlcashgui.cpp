// Copyright (c) 2019-2020 The HodlCash developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/hodlcash/hodlcashgui.h"
...
#include "qt/hodlcash/defaultdialog.h"
#include "qt/hodlcash/settings/settingsfaqwidget.h"
...
HodlCashGUI::HodlCashGUI(const NetworkStyle* networkStyle, QWidget* parent) :
    ...
    QString windowTitle = tr("Hodl Cash") + " - ";
...
void HodlCashGUI::createActions(const NetworkStyle* networkStyle){
 ...
 */
void HodlCashGUI::connectActions() {
    ...
    connect(topBar, &TopBar::showHide, this, &HodlCashGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &HodlCashGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &HodlCashGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &HodlCashGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &HodlCashGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &HodlCashGUI::showHide);
    connect(privacyWidget, &PrivacyWidget::showHide, this, &HodlCashGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &HodlCashGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::execDialog, this, &HodlCashGUI::execDialog);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &HodlCashGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &HodlCashGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &HodlCashGUI::execDialog);
}
...
void HodlCashGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Hodl Cash client") + " " + networkStyle->getTitleAddText();
...
void HodlCashGUI::handleRestart(QStringList args){
...
void HodlCashGUI::messageInfo(const QString& text){
...
void HodlCashGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle =  tr("Hodl Cash"); // default title
...
bool HodlCashGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn){
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("Hodl Cash"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
void HodlCashGUI::goToDashboard(){
...
void HodlCashGUI::goToSend(){
    showTop(sendWidget);
}

void HodlCashGUI::goToAddresses(){
    showTop(addressesWidget);
}

void HodlCashGUI::goToPrivacy(){
    showTop(privacyWidget);
}

void HodlCashGUI::goToMasterNodes(){
    showTop(masterNodesWidget);
}

void HodlCashGUI::goToColdStaking(){
    showTop(coldStakingWidget);
}

void HodlCashGUI::goToSettings(){
    showTop(settingsWidget);
}

void HodlCashGUI::goToReceive(){
    showTop(receiveWidget);
}

void HodlCashGUI::showTop(QWidget* view){
...
void HodlCashGUI::changeTheme(bool isLightTheme){
...
void HodlCashGUI::resizeEvent(QResizeEvent* event){
    // Parent..
...
bool HodlCashGUI::execDialog(QDialog *dialog, int xDiv, int yDiv){
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void HodlCashGUI::showHide(bool show){
...
int HodlCashGUI::getNavWidth(){
    return this->navMenu->width();
}

void HodlCashGUI::openFAQ(int section){
    showHide(true);
...
bool HodlCashGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(privacyWidget, &PrivacyWidget::message, this, &HodlCashGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &HodlCashGUI::message);
    connect(coldStakingWidget, &MasterNodesWidget::message, this, &HodlCashGUI::message);
    connect(topBar, &TopBar::message, this, &HodlCashGUI::message);
    connect(sendWidget, &SendWidget::message,this, &HodlCashGUI::message);
    connect(receiveWidget, &ReceiveWidget::message,this, &HodlCashGUI::message);
    connect(addressesWidget, &AddressesWidget::message,this, &HodlCashGUI::message);
    connect(settingsWidget, &SettingsWidget::message, this, &HodlCashGUI::message);
...
void HodlCashGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address) {
