...
#include "qt/hodlcash/furabstractlistitemdelegate.h"
#include "qt/hodlcash/txviewholder.h"
#include "qt/hodlcash/tooltipmenu.h"
#include "qt/hodlcash/sendmultirow.h"
#include "qt/hodlcash/coldstakingmodel.h"
#include "qt/hodlcash/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(HodlCashGUI* parent);
    ~ColdStakingWidget();
