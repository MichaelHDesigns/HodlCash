...
#ifndef HodlCash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define HodlCash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //HodlCash_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
