...
#include "qt/hodlcash/dashboardwidget.h"
#include "qt/hodlcash/forms/ui_dashboardwidget.h"
#include "qt/hodlcash/sendconfirmdialog.h"
#include "qt/hodlcash/txrow.h"
...
DashboardWidget::DashboardWidget(HodlCashGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of HODL staked."));
    ...
    ui->labelAmountPiv->setText("0 HODL");
    ...
    ui->btnHowTo->setText(tr("How to get HODL"));
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZHODL;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair HODL, zHODL
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("HODL");
    set1 = new QBarSet("zHODL");
