...
#include "qt/hodlcash/coldstakingwidget.h"
#include "qt/hodlcash/forms/ui_coldstakingwidget.h"
#include "qt/hodlcash/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/hodlcash/requestdialog.h"
#include "qt/hodlcash/tooltipmenu.h"
#include "qt/hodlcash/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(HodlCashGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your HODLs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept HODL delegation / Delegate HODL"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select HODL outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 HODL" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
