...
#include "qt/hodlcash/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/hodlcash/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(HodlCashGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to HodlCashGUI::handleRestart()
