...
#include "qt/hodlcash/settings/settingsnetworkwidget.h"
#include "qt/hodlcash/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/hodlcash/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(HodlCashGUI* _window, QWidget *parent) :
