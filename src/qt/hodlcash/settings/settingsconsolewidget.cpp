...
#include "qt/hodlcash/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/hodlcash/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(HodlCashGUI* _window, QWidget *parent) :
