...
#include "qt/hodlcash/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/hodlcash/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(HodlCashGUI* _window, QWidget *parent) :
