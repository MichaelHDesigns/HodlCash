...
#include "qt/hodlcash/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(HodlCashGUI* _window, QWidget *parent) :
