...
#include "qt/hodlcash/forms/ui_receivewidget.h"
...
#include "qt/hodlcash/addressholder.h"
...
ReceiveWidget::ReceiveWidget(HodlCashGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive HODL."));
