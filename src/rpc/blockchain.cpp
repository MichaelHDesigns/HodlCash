...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.push_back(Pair("zHODLsupply", zpivObj));
    ...
    if (block.IsProofOfStake()) {
        ...
        stakeData.push_back(Pair("stakeModifierHeight", ((stake->IsZHODL()) ? "Not available" : std::to_string(
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            "  \"zHODLsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zHODL denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zHODL denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zHODL denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zHODL denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zHODL denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zHODL denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zHODL denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zHODL denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zHODL denominations\n"
            "  }\n"
            "}\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), ZHODL_FAILED_ACCUMULATOR_INITIALIZATION);
