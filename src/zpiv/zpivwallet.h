// Copyright (c) 2017-2018 The HodlCash developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HodlCash_ZHODLWALLET_H
#define HodlCash_ZHODLWALLET_H
...
public:
    CzHODLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHODL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHODL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
