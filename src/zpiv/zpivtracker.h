...
#ifndef HodlCash_ZHODLTRACKER_H
#define HodlCash_ZHODLTRACKER_H
...
public:
    CzHODLTracker(std::string strWalletFile);
    ~CzHODLTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzHODLWallet* zHODLWallet = NULL);
