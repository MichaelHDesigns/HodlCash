...
public:
    ...
    int HodlCashBadBlockTime() const { return nHodlCashBadBlockTime; }
    int HodlCashBadBlocknBits() const { return nHodlCashBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nHodlCashBadBlockTime;
    unsigned int nHodlCashBadBlocknBits;
